...
Шагов восемь. Нумерация идёт от 00 до 06, но между 02 и 03 есть вставной шаг 02b (аудит пробелов) —
поэтому восемь, а не семь.
...
```
skills/        16 скиллов tms-* (подготовка /tms-new + процесс + аудит + рефакторинг)
