...
| 04 Реализация | `/tms-implement` | Пишет код волна за волной. Codex по умолчанию работает одним основным агентом; Claude держит M inline, добавляет bounded help для E и запускает реальные proving-role mobs для R/C. |
