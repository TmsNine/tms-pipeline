...
- Answer in /Users/user/Desktop/Projects/tms-pipeline.
- **Audience:** the reader is a non-technical product owner.
...
- **Lazy-load docs.** Don't read product/delivery docs until the task needs them; search the relevant
  subfolder for the one file you need. <<TODO: DOC_INDEX_HINT — fill this in (see the template comments in the tms-pipeline repo)>>
...
- **What it is:** Telegram bot
- **Code layout:** <<TODO: CODE_LAYOUT_HINT — fill this in (see the template comments in the tms-pipeline repo)>>
- **Persistence / tenancy:** <<TODO: PERSISTENCE_AND_TENANCY — fill this in (see the template comments in the tms-pipeline repo)>>
...
- Durable product / operations / architecture knowledge lives at: /Users/user/Yandex.Disk.localized/Obsidian/tmspiplenie

- The task pipeline folders live at: /Users/user/Desktop/Projects/tms-pipeline
- The backlog (single source of truth for tasks) is: /Users/user/Yandex.Disk.localized/Obsidian/tmspiplenie
- The traceability / requirements map (if any) is: <<TODO: TRACEABILITY_LOCATION — fill this in (see the template comments in the tms-pipeline repo)>>
- Ticket-ID format: proj-123
...
- Project commands: tests = `npm test`, typecheck = `<<TODO: TYPECHECK_CMD>>`, lint = `<<TODO: LINT_CMD>>`,
...
<<TODO: PROFILE_C_TRIGGERS — fill this in (see the template comments in the tms-pipeline repo)>>

## Database / Schema Migration Policy

<<TODO: MIGRATION_POLICY — fill this in (see the template comments in the tms-pipeline repo)>>
...
- **Actionable** → a new one-line row in the backlog (/Users/user/Yandex.Disk.localized/Obsidian/tmspiplenie): fresh ticket ID, area,
...
- Launch playbook location: <<TODO: LAUNCH_PLAYBOOK_LOCATION>>
- Stage → document mapping: <<TODO: LAUNCH_STAGE_MAPPING — fill this in (see the template comments in the tms-pipeline repo)>>
